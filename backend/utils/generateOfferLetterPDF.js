...
function generateOfferLetterPDF(offerLetter, outputPath) {
  return new Promise((resolve, reject) => {
    ...
    // Header: Logo top left (circular), company details top right
    ...
    const logoPath =
      offerLetter.companyLogo ||
      (fs.existsSync(newLogoPath) ? newLogoPath : oldLogoPath);
    const headerY = 30;
    ...
    doc
      ...
      .font("Helvetica-Bold")
      .fillColor("#4f46e5")
      .text(offerLetter.company || "Company Name", companyDetailsX, headerY, {
        width: 290,
        align: "right",
      });
    doc
      ...
      .fillColor("#444")
      .text(
        offerLetter.companyAddress ||
          "Patna, Bihar India, BR 800002 contact.studentera@gmail.com",
        companyDetailsX,
        headerY + 28,
    ...
    doc
      ...
      .fillColor("#666")
      .text(
        (offerLetter.companyEmail ? offerLetter.companyEmail + " | " : "") +
    ...
    doc
      .moveTo(30, headerY + 70)
      .lineTo(doc.page.width - 30, headerY + 70)
      .lineWidth(2)
      .strokeColor("#4f46e5")
      .stroke();
    ...
    doc
      ...
      .fontSize(22)
      .fillColor("#4f46e5")
      .text("LETTER OF OFFER", 0, headerY + 80, {
        align: "center",
        underline: true,
      });
    ...
    doc
      ...
      .fillColor("black")
      .text(
        `REF: ${offerLetter.referenceNo || "SE/INTERNSHIP/OFFER"}    Dated: ${
          offerLetter.issueDate
            ? new Date(offerLetter.issueDate).toLocaleDateString()
            : ""
        }`,
        0,
        subHeaderY,
    ...
    doc
      ...
      .font("Helvetica-Bold")
      .fillColor("#0e7490")
      .text(`Dear ${offerLetter.candidateName || "Candidate"},`, 60, contentY, {
        align: "left",
      });
    contentY += 22;
    doc
      ...
      .fillColor("#222")
      .text(
        `Intern ID: ${offerLetter.internId || "__________"}`,
        60,
        contentY,
        { align: "left" }
      );
    ...
    doc
      ...
      .fontSize(14)
      .fillColor("#1e293b")
      .text("Congratulations!!", 60, contentY, { align: "left" });
    contentY += 24;
    doc
      .font("Helvetica-Bold")
      .fontSize(13)
      .fillColor("#4f46e5")
      .text("STRICTLY PRIVATE & CONFIDENTIAL", 0, contentY, {
        align: "center",
        underline: true,
      });
    contentY += 22;
    doc
      ...
      .fillColor("black")
      .text(
        `We are pleased to offer you a Summer Internship with ${
          offerLetter.company || "the company"
        }, based on your application and the interview & discussions you had with us. Details of the terms & conditions of offer are as under:`,
        60,
        contentY,
    ...
    if (offerLetter.stipend && offerLetter.stipend > 0) {
      ...
      doc
        ...
        .fillColor("#1976d2")
        .text(
          `Stipend: ${rupeeSymbol}${offerLetter.stipend} /${
            offerLetter.stipendType || "month"
          }`,
          60,
          contentY,
          { align: "left" }
    ...
    const terms = [
      ...
      `Your date of commencement of internship will be from ${
        offerLetter.startDate || "__________"
      } in WFH mode.`,
      ...
      `${
        offerLetter.techPartner || "Our Technology Partner"
      } shall be the official Technology Partner for this internship.`,
    ...
    doc.moveDown(0.5);
    doc.text(
      "9. Kindly sign and return a copy of this letter as a token of your acceptance of the offer.",
      80,
      doc.y + 2,
    ...
    doc
      ...
      .font("Helvetica-Bold")
      .fillColor("#1e293b")
      .text(`For ${offerLetter.company || "the company"}`, 60, signY, {
        align: "left",
      });
    ...
    doc
      ...
      .fontSize(11)
      .fillColor("#222")
      .text(`${offerLetter.hrName || "HR Name (HR)"}`, 60, signY + 38, {
        align: "left",
      });
    // Stamp (right)
    const stampPath =
      offerLetter.companyStamp ||
      path.join(__dirname, "../templates/stamp.png");
    if (typeof stampPath === "string" && fs.existsSync(stampPath)) {
      doc
        .opacity(0.5)
        .image(stampPath, doc.page.width - 140, signY, { width: 80 })
        .opacity(1);
    } else {
    ...
    doc
      ...
      .fontSize(11)
      .fillColor("#222")
      .text("Intern's Signature", 60, sigLineY, { align: "left" });
    doc
      .moveTo(160, sigLineY + 12)
      .lineTo(300, sigLineY + 12)
      .strokeColor("#888")
      .lineWidth(1)
      .stroke();
    doc
      ...
      .fontSize(11)
      .fillColor("#222")
      .text("College", 320, sigLineY, { align: "left" });
    doc
      .moveTo(380, sigLineY + 12)
      .lineTo(520, sigLineY + 12)
      .strokeColor("#888")
      .lineWidth(1)
      .stroke();
