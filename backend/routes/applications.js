...
router
  .route("/")
  .get(protect, authorize("admin", "accountant"), getAllApplications);
router
  .route("/:id/status")
  .put(protect, authorize("admin", "accountant"), updateApplicationStatus);
router
  .route("/:id/payment-received")
  .put(protect, authorize("admin", "accountant"), updatePaymentReceived);
router.route("/:id/refund").put(protect, authorize("admin"), processRefund);
