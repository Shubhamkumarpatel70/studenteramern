        ...
        <div className="p-6 bg-gray-50 min-h-screen">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mb-8">
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {error && <div className="md:col-span-2 text-red-500 text-center p-2 bg-red-50 rounded-md">{error}</div>}
                    {success && <div className="md:col-span-2 text-green-500 text-center p-2 bg-green-50 rounded-md">{success}</div>}
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                {assignedTasks.length === 0 ? (
                    <p className="text-gray-500 text-center py-8">No tasks have been assigned yet.</p>
                ) : (
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {assignedTasks.map(task => (
                                    <tr key={task._id}>
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="flex items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="text-sm text-gray-500">{task.user.internId}</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="flex items-center">
                                                ...
                                                <div>
                                                    <div className="text-sm font-medium text-gray-900">{task.internship.title}</div>
                                                    <div className="text-sm text-gray-500">{task.internship.company}</div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{task.domain}</td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="flex items-center">
