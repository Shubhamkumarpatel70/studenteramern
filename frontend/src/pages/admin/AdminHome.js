...
const StatCard = ({ icon, title, value, color, trend, subtitle }) => (
    <div className={`p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 ${color} relative overflow-hidden`}>
...
const QuickActionCard = ({ icon, title, description, link, color }) => (
    <Link to={link} className="block">
        <div className={`p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 ${color} group cursor-pointer`}>
