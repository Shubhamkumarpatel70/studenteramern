...
import { Loader2, AlertCircle, Calendar, MapPin, Code, IndianRupee, ArrowLeft } from 'lucide-react';
        ...
        <div className="bg-gray-50 min-h-screen py-8">
            <div className="container mx-auto px-4 py-8">
                <div className="mb-6">
                    <button
                        onClick={() => navigate(-1)}
                        className="inline-flex items-center gap-2 px-4 py-2 text-indigo-600 hover:text-indigo-800 font-medium transition-colors duration-200"
                    >
